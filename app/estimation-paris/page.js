...
const secteurs = [
  ...
  { code: "12–15e", nom: "Paris résidentiel Sud", fourchette: "8 200 – 11 500 €/m²", note: "Idéal familles, marché stable, bonne qualité de vie" },
  { code: "16–17e", nom: "Ouest résidentiel", fourchette: "8 700 – 13 500 €/m²", note: "Trocadéro, Passy, Batignolles — très variés selon la rue" },
  { code: "18–20e", nom: "Paris Nord-Est dynamique", fourchette: "7 300 – 10 500 €/m²", note: "Montmartre, Belleville — secteur le plus accessible, meilleur potentiel" },
];
...
export default function Page() {
  return (<>
    ...
    <main className="seo-page">
      ...
      <p>Les outils d'estimation automatique se basent sur des moyennes. Marie Houlier, elle, connaît votre immeuble, votre rue, la copropriété et le micro-marché de votre quartier. Cette connaissance terrain est irremplaçable.</p>

      <h2>Prix au m² à Paris en 2026 — par grand secteur</h2>
      <p>Ces fourchettes sont indicatives et reflètent la médiane parisienne d'environ 9 700-9 800 €/m² au premier semestre 2026. Consultez notre <Link href="/prix-m2-paris">tableau complet des prix par arrondissement</Link> pour le détail.</p>
      ...
      <ul className="seo-list">
        ...
        <li><strong>Le DPE (performance énergétique)</strong> — les logements F et G se vendent désormais 12 à 22 % en dessous du marché.</li>
