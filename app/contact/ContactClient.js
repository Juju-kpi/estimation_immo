      ...
      <div className="contact-container">
        <Reveal className="contact-text reveal-left">
          ...
          <div className="contact-direct">
            <a href="tel:+33752049878" className="contact-phone-link"><Phone size={16} /> 07 52 04 98 78</a>
            <a href="mailto:contact@sellmyhome.fr" className="contact-mail-link"><Mail size={16} /> contact@sellmyhome.fr</a>
          </div>
        </Reveal>
