...
const faq = [
  ...
  { q: "Quels sont les frais pour vendre un appartement à Paris ?", a: "Le vendeur paie : les honoraires d'agence (si mandat agence), les diagnostics (300 à 600 €), éventuellement les frais de mainlevée d'hypothèque. Les frais de notaire (7 à 8 % environ) sont à la charge de l'acheteur. L'impôt sur la plus-value s'applique si le bien n'est pas votre résidence principale." },
...
const etapes = [
  ...
  { num: "02", titre: "Constitution du dossier & diagnostics", desc: "Diagnostic de performance énergétique (DPE), Carrez, amiante, plomb, électricité, gaz… Le dossier de diagnostic technique doit être complet avant la signature du compromis. Marie coordonne tout." },
  ...
  { num: "06", titre: "Négociation & sécurisation de la vente", desc: "En cas d'offre, Marie vous conseille sur la position à adopter et négocie dans votre intérêt. Elle coordonne ensuite avec les notaires jusqu'à la signature de l'acte authentique." },
];
...
export default function Page() {
  return (<>
    ...
    <main className="seo-page">
      ...
      <p>La constitution du dossier de diagnostic technique (DDT) est une étape légale incontournable. Voici les principaux diagnostics à prévoir :</p>
      ...
      <p>Le coût total des diagnostics est généralement de 300 à 600 € à Paris. SellMyHome peut vous recommander des diagnostiqueurs certifiés.</p>
      ...
      <div className="seo-internal-links">
        <p>À lire aussi : <Link href="/estimation-paris">Estimation immobilière Paris</Link> · <Link href="/prix-m2-paris">Prix m² Paris 2026</Link> · <Link href="/chasseur-paris">Chasseur immobilier Paris</Link> · <Link href="/estimation-appartement">Estimation appartement</Link></p>
      </div>
