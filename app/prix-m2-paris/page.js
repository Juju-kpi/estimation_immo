...
const prix = [
  { arr:"1er", min:11000, max:14500, t:"→ Stable", note:"Centre historique, tourisme, forte demande" },
  { arr:"2e",  min:10500, max:13500, t:"→ Stable", note:"Sentier, Bourse — en plein essor" },
  { arr:"3e",  min:11000, max:14000, t:"↗ Hausse", note:"Haut Marais, très recherché" },
  { arr:"4e",  min:11500, max:15000, t:"→ Stable", note:"Île Saint-Louis, Notre-Dame, premium" },
  { arr:"5e",  min:11000, max:14500, t:"→ Stable", note:"Quartier latin, clientèle intellectuelle" },
  { arr:"6e",  min:13000, max:17000, t:"↗ Hausse", note:"Saint-Germain — parmi les plus chers" },
  { arr:"7e",  min:12500, max:16500, t:"→ Stable", note:"Invalides, Tour Eiffel, très résidentiel" },
  { arr:"8e",  min:11000, max:14500, t:"→ Stable", note:"Champs-Élysées, clientèle internationale" },
  { arr:"9e",  min:10000, max:13000, t:"↗ Hausse", note:"Pigalle, Trinité — forte demande jeune CSP+" },
  { arr:"10e", min:9000,  max:12000, t:"↗ Hausse", note:"Canal Saint-Martin — en forte progression" },
  { arr:"11e", min:9500,  max:12500, t:"→ Stable", note:"Oberkampf, Bastille — valeurs sûres" },
  { arr:"12e", min:9000,  max:11500, t:"→ Stable", note:"Nation, Bercy — résidentiel calme" },
  { arr:"13e", min:8500,  max:11000, t:"↘ Légère", note:"Italie, Gobelins — légère pression DPE" },
  { arr:"14e", min:9000,  max:12000, t:"→ Stable", note:"Montparnasse, Alésia — stable" },
  { arr:"15e", min:9000,  max:12000, t:"→ Stable", note:"Plus grand arrondissement, très familial" },
  { arr:"16e", min:9500,  max:14000, t:"→ Stable", note:"Très variable selon rue : Passy vs Auteuil" },
  { arr:"17e", min:9000,  max:12500, t:"↗ Hausse", note:"Batignolles en forte hausse, Monceau premium" },
  { arr:"18e", min:8000,  max:11000, t:"↗ Hausse", note:"Montmartre, Clignancourt — meilleur potentiel" },
  { arr:"19e", min:7500,  max:10000, t:"↗ Hausse", note:"Parc des Buttes-Chaumont — en pleine transformation" },
  { arr:"20e", min:7500,  max:10500, t:"↗ Hausse", note:"Belleville, Père-Lachaise — dynamique" },
];

const faq = [
  { q: "Quel est le prix moyen au m² à Paris en 2026 ?", a: "Le prix médian à Paris est d'environ 9 800 €/m² en 2026, avec de fortes disparités : de 7 500 €/m² dans les 19e et 20e à plus de 15 000 €/m² dans les 6e et 7e arrondissements." },
  { q: "Les prix immobiliers à Paris baissent-ils en 2026 ?", a: "Après la correction de 2023-2024 (-8 % environ), le marché s'est stabilisé en 2025 et connaît une légère reprise en 2026, portée par la baisse des taux et le retour des acheteurs, notamment dans le nord-est parisien." },
...
export default function Page() {
  return (<>
    ...
    <main className="seo-page">
      ...
      <p className="prix-source">Sources : DVF Etalab, Notaires de France, données 1er trimestre 2026. Fourchettes indicatives pour appartements en bon état.</p>
      ...
      <ul className="seo-list">
        <li><strong>Le DPE (performance énergétique)</strong> — un logement F ou G peut perdre 10 à 20 % par rapport à un bien classé C/D, et la tendance s'accentue avec les nouvelles lois.</li>
      ...
      <p>Après deux années de correction (2023-2024), le marché parisien a commencé sa stabilisation en fin 2025. En 2026, la légère baisse des taux d'intérêt a redonné du pouvoir d'achat aux acquéreurs. Les arrondissements du nord-est (9e, 10e, 17e, 18e, 19e, 20e) connaissent les hausses les plus dynamiques, portés par un effet de rattrapage et l'attractivité croissante de ces secteurs.</p>
      <p>Les arrondissements de prestige (6e, 7e, 4e) restent stables à des niveaux élevés, avec une clientèle internationale toujours présente. Le réseau Leggett auquel SellMyHome est affilié touche directement ces acquéreurs étrangers.</p>
      ...
      <div className="seo-internal-links">
        <p>À lire aussi : <Link href="/estimation-paris">Estimation immobilière gratuite à Paris</Link> · <Link href="/vendre-a-paris">Vendre un appartement à Paris</Link> · <Link href="/chasseur-paris">Chasseur immobilier Paris</Link></p>
      </div>
