export default function sitemap() {
  ...
  return [
    ...
    { url: `${base}/diagnostic-immobilier-paris`,                  lastModified: now, changeFrequency: "monthly", priority: 0.85 },
    { url: `${base}/frais-notaire-paris`,                          lastModified: now, changeFrequency: "monthly", priority: 0.80 },
    { url: `${base}/vendre-appartement-succession-paris`,          lastModified: now, changeFrequency: "monthly", priority: 0.85 },
    { url: `${base}/vendre-appartement-divorce-paris`,             lastModified: now, changeFrequency: "monthly", priority: 0.85 },
    { url: `${base}/vendre-appartement-rapidement-paris`,          lastModified: now, changeFrequency: "monthly", priority: 0.85 },
    { url: `${base}/vendre-maison-retraite-paris`,                 lastModified: now, changeFrequency: "monthly", priority: 0.80 },
    { url: `${base}/vendre-avant-achat-paris`,                     lastModified: now, changeFrequency: "monthly", priority: 0.80 },
