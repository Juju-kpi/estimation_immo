    ...
    <nav className="navbar" role="navigation" aria-label="Navigation principale">
      <div className="nav-container">
        <Link href="/" className="nav-logo" aria-label="SellMyHome — Accueil">
          <Image src="/logo.png" alt="SellMyHome — estimation immobilière Paris et Île-de-France" width={170} height={75} priority quality={90} />
        </Link>
        <div className="nav-links">
          ...
          <Link href="/estimation-ile-de-france" className={nl("/estimation-ile-de-france")} onClick={() => trackClick("nav_idf")}>Île-de-France</Link>
          <Link href="/chasseur-paris" className={nl("/chasseur-paris")} onClick={() => trackClick("nav_chasseur")}>Acheter</Link>
